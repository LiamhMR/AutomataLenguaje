...
public interface ParserTVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ParserTParser#mathpot}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMathpot(ParserTParser.MathpotContext ctx);
	/**
	 * Visit a parse tree produced by {@link ParserTParser#mathfact}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMathfact(ParserTParser.MathfactContext ctx);
	/**
