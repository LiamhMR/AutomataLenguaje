...
public interface ParserTVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitMathmult(@NotNull ParserTParser.MathmultContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMathless(@NotNull ParserTParser.MathlessContext ctx);
	/**
	 * Visit a parse tree produced by {@link ParserTParser#mathsplit}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMathsplit(@NotNull ParserTParser.MathsplitContext ctx);
	/**
	 * Visit a parse tree produced by {@link ParserTParser#mathplus}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMathplus(@NotNull ParserTParser.MathplusContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMath(@NotNull ParserTParser.MathContext ctx);
	/**
