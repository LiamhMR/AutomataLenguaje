...
public interface ParserTListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterMathmult(@NotNull ParserTParser.MathmultContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserTParser#mathmult}.
	 * @param ctx the parse tree
	 */
	void exitMathmult(@NotNull ParserTParser.MathmultContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterMathless(@NotNull ParserTParser.MathlessContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserTParser#mathless}.
	 * @param ctx the parse tree
	 */
	void exitMathless(@NotNull ParserTParser.MathlessContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserTParser#mathsplit}.
	 * @param ctx the parse tree
	 */
	void enterMathsplit(@NotNull ParserTParser.MathsplitContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserTParser#mathsplit}.
	 * @param ctx the parse tree
	 */
	void exitMathsplit(@NotNull ParserTParser.MathsplitContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserTParser#mathplus}.
	 * @param ctx the parse tree
	 */
	void enterMathplus(@NotNull ParserTParser.MathplusContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserTParser#mathplus}.
	 * @param ctx the parse tree
	 */
	void exitMathplus(@NotNull ParserTParser.MathplusContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterMath(@NotNull ParserTParser.MathContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserTParser#math}.
	 * @param ctx the parse tree
	 */
	void exitMath(@NotNull ParserTParser.MathContext ctx);
	/**
